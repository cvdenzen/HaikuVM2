...
public class ArithmeticTest {
     ...
     * 1) Mode = 32/64
     * 2) InternalExceptionEnable = NullPointerException | NoSuchMethodError | OutOfMemoryError | ClassCastException | VirtualMachineError | ArrayIndexOutOfBoundsException | StackOverflowError | ArithmeticException
     *      at least: 
     *    InternalExceptionEnable = ArithmeticException
     * 3) InternalExceptionThrow = 1
