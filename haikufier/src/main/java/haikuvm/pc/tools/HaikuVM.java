...
Use the -h or --help flag to print out the options.
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println();
            System.out.println("$Version 1.1.1 $ $Date: 2013-11-14 19:18:55 +0100 (do, 14 nov 2013) $");
            System.out.println();
    ...
    public static void haikulink(String[] args) throws Exception {
		...
		for (int i = 0; i < args.length; i++) {
			if (false) {
				...
				// not jet supported
					...
					|| args[i].equals("-ec")) {
				HaikuDefs.setProperty("InternalExceptionEnable", "0xffff");
		...
		if (classnames.size()>0) {
			...
			haikuConfigc.println();
			haikuConfigc.println();
			haikuConfigc.println("const Exception_t	exceptionTable[] PROGMEM = {");
     ...
     * @throws Exception 
     */
    public static int executeBlocking(String[] args) throws Exception {
...
//        Thread terr = new ByteFlushThread(p.getErrorStream(), verbose?System.err:null, "-err");
    ...
    public static String getProgram() {
        return program==null?"":program.replace("\r", "");
    }
