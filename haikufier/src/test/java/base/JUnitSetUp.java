...
public class JUnitSetUp
{
    ...
    public static void testee(String clazz, String type) throws InterruptedException, Exception {
        ...
        int error = HaikuVM.executeBlocking(new String[] {
        ...
        PrintWriter junitOut = new PrintWriter(new FileWriter("src/test/resources/junit_" + target + "_"
        ...
        junitOut.println("##########  " + HaikuVM.getProgram());
        junitOut.println("##########  " + HaikuVM.getData());
