...
public class HaikuMicroKernelEx extends haiku.vm.MicroKernel {
    ...
    public static void main(String[] args) {
        try {
            ...
            /**
             * The following call of throwException() and consequently the
             * method body throwException() will be extincted from code if
             * property Target.InternalExceptionThrow is set to 0 ..
