...
public class Thread implements Runnable {
	...
	static private final int YIELD = 2;
	//static private final int INIT = 4;
	static private final int WAITING = 6;
	static private final int STOPPED = 8;
	
	public static final int MAX_PRIORITY = 0;
	public static final int NORM_PRIORITY = 0;
	public static final int MIN_PRIORITY = 0;
	
    // Note the following fields are mapped on to a C struct
	...
	static private volatile Thread currentThread; // read only
	...
	private volatile Object locks; // HaikuVM will use this for a entry in a queue of locks
	 ...
	 *  thisThread->stack=new StackFrame(36); // so on thisThreads stack, top stack element is an integer 0 
	 *  push the integer 1 // in contrast on current stack, top stack element is integer 1 </pre>
    ...
    public void run$() {
        try {
            ...
            // But induces unwanted IO even in very simple Thread examples (e.g. asuro-BlinkWithThread)
        }
